...
inline const char* T(TK key, Lang lang) {
    ...
    switch (key) {
        ...
        case TK::InstructionsBody: return pt
            ? "CONTROLES: tudo no mouse ou toque (PC, celular e web).\n"
              "\n"
              "MIRA: uma linha oscila de -90 a 90 graus na direcao do\n"
              "oponente. Clique (ou toque) para travar o angulo.\n"
              "\n"
              "FORCA: uma barra oscila de fraco (verde) a forte (vermelho).\n"
              "Clique de novo para travar e disparar.\n"
              "No PC: B ou o botao de resetar angulo voltam a fase de mira.\n"
              "\n"
              "VENTO: indicado no topo; empurra o projetil no voo.\n"
              "Sempre da para compensar com angulo e forca.\n"
              "\n"
              "TERRENO: destrutivel - cada explosao abre uma cratera.\n"
              "Se o chao embaixo do canhao sumir por completo, voce perde\n"
              "(enterro). 3 acertos diretos tambem destroem um canhao.\n"
              "\n"
              "CLASSIC / PLUS: escolha no canto superior esquerdo do menu.\n"
              "Plus: a cada 4 turnos surge um power-up no mapa.\n"
              "Acerte com o tiro para pegar: dano em dobro, trajetoria\n"
              "prevista, tiro teleguiado, cura ou escudo.\n"
              "\n"
              "MODOS: 1 jogador (vs IA), 2 jogadores local, multiplayer\n"
              "online (lobby com desafios e salas de equipe) e loja\n"
              "cosmetica com moedas ganhas nas partidas."
            : "CONTROLS: mouse or touch everywhere (PC, phone, web).\n"
              "\n"
              "AIM: a line swings from -90 to 90 degrees toward the\n"
              "opponent. Click (or tap) to lock the angle.\n"
              "\n"
              "POWER: a bar swings from weak (green) to strong (red).\n"
              "Click again to lock and fire.\n"
              "On PC: B or the reset-angle button return to aiming.\n"
              "\n"
              "WIND: shown at the top; pushes the projectile in flight.\n"
              "You can always compensate with angle and power.\n"
              "\n"
              "TERRAIN: destructible - each blast digs a crater.\n"
              "If the ground under a cannon is gone, that player loses\n"
              "(burial). 3 direct hits also destroy a cannon.\n"
              "\n"
              "CLASSIC / PLUS: pick at the top-left of the main menu.\n"
              "Plus: every 4 turns a power-up spawns on the map.\n"
              "Hit it with your shot to pick up: double damage, trajectory\n"
              "preview, guided shot, heal, or shield.\n"
              "\n"
              "MODES: 1 player (vs AI), 2 players local, online\n"
              "multiplayer (lobby with challenges and team rooms), and a\n"
              "cosmetic shop with coins earned from matches.";
